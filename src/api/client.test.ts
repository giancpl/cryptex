...
it("exposes a mockable typed backend contract", async () => {
  ...
  const client: BackendClient = {
    ...
    notationDiagnostics: () => Promise.reject(new Error("not used")),
    notationSuppressions: () => Promise.reject(new Error("not used")),
    previewNotationRename: () => Promise.reject(new Error("not used")),
    applyNotationRename: () => Promise.reject(new Error("not used")),
    setNotationSuppressions: () => Promise.reject(new Error("not used")),
    ...
    importNotationProfile: () => Promise.reject(new Error("not used")),
    exportNotationProfile: () => Promise.reject(new Error("not used")),
    ...
    inverseSynctex: () => Promise.reject(new Error("not used")),
